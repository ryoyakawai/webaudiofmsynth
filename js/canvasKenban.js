/** 
 * @license canvasKenban.js 1.0.0 Copyright (c) 2012, Ryoya KAWAI All Rights Reserved.
 * Available via the MIT or new BSD license.
 */

function canvasKenban(noteOnCallback, noteOffCallback) {
  var canvasSize = { 'width': 680, 'height': 110 };
  ...
  for(var i=0; i<=20; i++) {
    ...
    context.fillRect(x, 5, 30, 110); // fill white
    context.strokeStyle = '#000000';  
    context.strokeRect(x, 5, 30, 110); // stroke rect
    var x_d_start = x;
    var x_d_end = x + 30;
  ...
  for(var i=0; i<=20; i++) {
    keyCount++;
      ...
      context.fillRect  (x, 5, 20,  70); // fill black
    }
    if(keyCount==7) keyCount=0;
  }
  // set axis value
